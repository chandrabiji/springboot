package com.chandra.SpringBoot_Thyemleaf_H2_JPA_REST.controller;
...
import com.chandra.SpringBoot_Thyemleaf_H2_JPA_REST.service.EmployeeService;
...
public class EmployeeController {
	...
	public String editEmployeeById(Model model, @PathVariable Optional<Long> id) throws Exception {
		if (id.isPresent()) {
